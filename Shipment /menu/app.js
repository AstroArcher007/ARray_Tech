...
(function () {
  ...
  function renderSpecials(dishes) {
    ...
    specialTrack.innerHTML = specials
      .map(
        (dish) => `
        <article class="special-card${dish.isSoldOut ? " special-card--sold-out" : ""}">
          ${CORNER_FLOURISH}
          ...
          <div class="special-card__name-row">
            ...
            ${dish.isSoldOut ? `<span class="menu-item__badge menu-item__badge--soldout">Sold out</span>` : ""}
          </div>
  ...
  function renderMenuItem(dish) {
    ...
    return `
      <div class="menu-item${soldOut ? " menu-item--sold-out" : ""}">
        <div class="menu-item__main">
          <div class="menu-item__name-row">
            ...
            ${soldOut ? `<span class="menu-item__badge menu-item__badge--soldout">Sold out</span>` : ""}
          </div>
